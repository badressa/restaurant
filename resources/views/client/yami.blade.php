		...
		<nav class="navbar navbar-expand-lg navbar-light bg-light">
			<div class="container">
				<a class="navbar-brand" href="index.html">
					<img src="{{ asset('frontend/yami/images/logo.png') }}" alt="" />
				</a>
	...
	<div id="slides" class="cover-slides">
		<ul class="slides-container">
			<li class="text-center">
				<img src="{{ asset('frontend/yami/images/slider-01.jpg') }}" alt="">
				<div class="container">
					<div class="row">
						<div class="col-md-12">
			...
			<li class="text-center">
				<img src="{{ asset('frontend/yami/images/slider-02.jpg') }}" alt="">
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<h1 class="m-b-20"><strong>Welcome To <br> Yamifood Restaurant</strong></h1>
			...
			<li class="text-center">
				<img src="{{ asset('frontend/yami/images/slider-03.jpg') }}" alt="">
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<h1 class="m-b-20"><strong>Welcome To <br> Yamifood Restaurant</strong></h1>
	...
	<div class="menu-box">
		<div class="container">
			...
			<div class="row special-list">
				...
				<div class="col-lg-4 col-md-6 special-grid drinks">
					<div class="gallery-single fix">
						<img src="{{ asset('frontend/yami/images/img-02.jpg') }}" class="img-fluid" alt="Image">
						<div class="why-text">
				...
				<div class="col-lg-4 col-md-6 special-grid drinks">
					<div class="gallery-single fix">
						<img src="{{ asset('frontend/yami/images/img-03.jpg') }}" class="img-fluid" alt="Image">
						<div class="why-text">
				...
				<div class="col-lg-4 col-md-6 special-grid lunch">
					<div class="gallery-single fix">
						<img src="{{ asset('frontend/yami/images/img-04.jpg') }}" class="img-fluid" alt="Image">
						<div class="why-text">
				...
				<div class="col-lg-4 col-md-6 special-grid lunch">
					<div class="gallery-single fix">
						<img src="{{ asset('frontend/yami/images/img-05.jpg') }}" class="img-fluid" alt="Image">
						<div class="why-text">
				...
				<div class="col-lg-4 col-md-6 special-grid lunch">
					<div class="gallery-single fix">
						<img src="{{ asset('frontend/yami/images/img-06.jpg') }}" class="img-fluid" alt="Image">
						<div class="why-text">
				...
				<div class="col-lg-4 col-md-6 special-grid dinner">
					<div class="gallery-single fix">
						<img src="{{ asset('frontend/yami/images/img-07.jpg') }}" class="img-fluid" alt="Image">
						<div class="why-text">
				...
				<div class="col-lg-4 col-md-6 special-grid dinner">
					<div class="gallery-single fix">
						<img src="{{ asset('frontend/yami/images/img-08.jpg') }}" class="img-fluid" alt="Image">
						<div class="why-text">
				...
				<div class="col-lg-4 col-md-6 special-grid dinner">
					<div class="gallery-single fix">
						<img src="{{ asset('frontend/yami/images/img-09.jpg') }}" class="img-fluid" alt="Image">
						<div class="why-text">
