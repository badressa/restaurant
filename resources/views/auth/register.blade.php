<x-guest-layout>
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div>
                <x-jet-label for="fname" value="{{ __('Family Name') }}" />
            ...
            <div class="mt-4">
                ...
                <x-jet-input id="tel" class="block mt-1 w-full" type="text" name="tel" required autocomplete="tel" />
            </div>

            <div class="mt-4">
                <x-jet-label for="hbt" value="{{ __('Date de naissance') }}" />
                <x-jet-input id="hbt" class="block mt-1 w-full" type="date" name="hbt" required autocomplete="new-hbt" />
            </div>
            
            <div class="mt-4">
                <x-jet-label for="sexe" value="{{ __('Gender') }}" />
                <select id="sexe"  class="block mt-1 w-full" name="gender">
